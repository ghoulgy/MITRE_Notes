...
![call_runonce_from_explorer.png](./images/call_runonce_from_explorer.png)

![explorer_run6432_param.PNG](./images/explorer_run6432_param.PNG)
...
![runonce_parse_cmd.PNG](./images/runonce_parse_cmd.PNG)
...
![runonce_exec_reg_app_enum_proc.png](./images/runonce_exec_reg_app_enum_proc.png)

![runonce_SHEnumRegApps.PNG](./images/runonce_SHEnumRegApps.PNG)
...
![rundll32_shell32_dll_reg_run_data.PNG](./images/rundll32_shell32_dll_reg_run_data.PNG)
...
![rundll32_shell32_dll_reg_run_data.PNG](./images/runonce_alternateshellstartup.PNG)
...
![rundll32_shell32_dll_reg_run_data.PNG](./images/runonce_RunStuffHasBeenRun.PNG)
...
![runonce_processrun.PNG](./images/runonce_processrun.PNG)
...
![runonce_runstartupgroup.PNG](./images/runonce_runstartupgroup.PNG)

Inside `Startup_ExecuteRegAppEnumProc()`, it will load `ExecuteRegAppEnumProc()` -> `_ShellExecuteRegAppWorker()` -> `ShellExecuteRunApp()`.

![runonce_shellexecuterunapp.PNG](./images/runonce_shellexecuterunapp.PNG)
...
![runonce_dispatch_call.png](./images/runonce_dispatch_call.png)
...
![winlogon_split_comma.png](./images/winlogon_split_comma.png)
...
![startup_path_CreatThread.PNG](./images/startup_path_CreatThread.PNG)

From `RunStartupAppsThreadProc()` ---Executes---> `_ProcessStartupGroup()`
![startup_path_RunStartupAppsThreadProc.PNG](./images/startup_path_RunStartupAppsThreadProc.PNG)
...
![startup_path_ProcessStartupGroup.PNG](./images/startup_path_ProcessStartupGroup.PNG)

From `EnumFolder()` ---Executes---> `ExecStartupEnumProc`
![startup_path_EnumFolder.PNG](./images/startup_path_EnumFolder.PNG)

COM Object `ISHellLinkW` and `IContextMenu` loaded and execute the .lnk file in the startup path via `InvokeCommand`

![startup_path_ExecStartupEnumProc.PNG](./images/startup_path_ExecStartupEnumProc.PNG)

It can be verify via stack trace from `procmon`  
The stack offset will redirect to the relevant line of code.

![startup_path_procmon_InvokeCommand.png](./images/startup_path_procmon_InvokeCommand.png)
