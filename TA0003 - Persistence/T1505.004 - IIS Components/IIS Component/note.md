...
![site_modules.PNG](./images/site_modules.PNG)
...
![inetmgr_load_module.PNG](./images/inetmgr_load_module.PNG)
...
![iis_module_list.PNG](./images/iis_module_list.PNG)
...
![iis_backdoor_module.PNG](./images/iis_backdoor_module.PNG)
...
![iis_conf_ops_evt_log.PNG](./images/iis_conf_ops_evt_log.PNG)

### Network

It is similar to (T1505.003 - IIS Web Shell), but the payload module here is IIS-Raid.

![iis_backdoor_module_http_packet_from_attacker.PNG](./images/iis_backdoor_module_http_packet_from_attacker.PNG)

![iis_backdoor_module_http_packet_to_attacker.PNG](./images/iis_backdoor_module_http_packet_to_attacker.PNG)
