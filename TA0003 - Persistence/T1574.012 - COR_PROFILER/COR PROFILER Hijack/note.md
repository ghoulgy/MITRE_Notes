...
![getconfigvalue_COR.png](./images/getconfigvalue_COR.PNG)
...
![snapin_clr_dll.png](./images/snapin_clr_dll.png)

Does not load clr.dll if **NOT** `CFxSnapInReference` loaded  
![snapin_no_clr_dll.png](./images/snapin_no_clr_dll.png)
...
![mmc_dotnet_process_hacker.png](./images/mmc_dotnet_process_hacker.PNG)
...
![winevtlog_application_error_1022.png](./images/winevtlog_application.png)
