...
![app_web_module_load.PNG](./images/app_web_module_load.PNG)

It will loads into .net assemblies as well.

![dotnet_module_w3wp.PNG](./images/dotnet_module_w3wp.PNG)
...
![asp_file_compilation.PNG](./images/asp_file_compilation.PNG)
...
![application_pool_identity.PNG](./images/application_pool_identity.PNG)

### Default Physical Path

The default phyiscal path is `%SystemDrive%\inetpub\wwwroot`

![default_phy_path.PNG](./images/default_phy_path.PNG)
...
![IIS_logging.PNG](./images/IIS_logging.PNG)
...
![IIS_logfiles_text.PNG](./images/IIS_logfiles_text.PNG)

![IIS_evt_log.png](./images/IIS_evt_log.png)
