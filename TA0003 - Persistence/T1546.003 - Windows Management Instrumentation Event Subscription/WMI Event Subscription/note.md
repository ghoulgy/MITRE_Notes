...
Noteable Call Stack  
Initiation part
![stack_trace_cexecclassfactory_createinstance.png](./images/stack_trace_cexecclassfactory_createinstance.PNG)

Loading the script text inside `CScriptSink::Initialize`
![stack_trace_cexecclassfactory_createinstance.png](./images/stack_trace_cscript_initialize.PNG)

The script text code will be execute in `CScriptSink::RunScriptText`
![stack_trace_runscripttext.PNG](./images/stack_trace_runscripttext.PNG)
