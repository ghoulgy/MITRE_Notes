...
![net_support_netstat.PNG](./images/net_support_netstat.PNG)

Here is the IDAPro decompiler view on `TCCTL32.dll`

![net_support_port.PNG](./images/net_support_port.PNG)
...
![net_support_client_ini.PNG](./images/net_support_client_ini.PNG)

Here is the first HTTP request from the listener to its connector after it starts listening to the port mentioned above.

![net_support_init_ping_to_connector.PNG](./images/net_support_init_ping_to_connector.PNG)

Here are the files that locate together along with the listener in same folder.

![net_support_folder_items.PNG](./images/net_support_folder_items.PNG)
