...
![outlook_interface_inbox.png](./images/outlook_interface_inbox.png)

It can be seen under `procmon` monitoring.

![outlook_inetcache.PNG](./images/outlook_inetcache.PNG)

The attachment handling path has been declared in the key data of the `OutlookSecureTempFolder`.

![outlook_security_settings.png](./images/outlook_security_settings.png)
...
![outlook_always_ask.PNG](./images/outlook_always_ask.PNG)
...
![proc_tree_outlook_chrome.png](./images/proc_tree_outlook_chrome.png)

Edge

![proc_tree_outlook_edge.png](./images/proc_tree_outlook_edge.png)

Firefox

![proc_tree_outlook_firefox.png](./images/proc_tree_outlook_firefox.png)
