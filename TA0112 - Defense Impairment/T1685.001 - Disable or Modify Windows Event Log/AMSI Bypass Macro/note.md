...
![macro_amsi_bypass_ordinal_1](./images/macro_amsi_bypass_ordinal_1.png)
...
![macro_amsi_bypass_classic_1](./images/macro_amsi_bypass_classic_1.png)
...
![macro_amsi_bypass_heap_1](./images/macro_amsi_bypass_heap_1.png)
...
![trusted_feature_1](./images/trusted_feature_1.png)
...
![trusted_feature_reg_key_word_1](./images/trusted_feature_reg_key_word_1.png)

### TrustedRecords

`TrustedRecords` indicates that the macro `Enable Content` has been approved by the user.

![trusted_feature_reg_key_word_2](./images/trusted_feature_reg_key_word_2.png)

`TrustedRecords` registry key will not be seen if user remove via the following method:

![trusted_feature_clear_trust_documents](./images/trusted_feature_clear_trust_documents.png)
...
![trusted_feature_2](./images/trusted_feature_2.png)

The following registry key will be added if user tick on `Disable Trusted Documents`

![disable_trust_doc_reg_key](./images/disable_trust_doc_reg_key.png)
