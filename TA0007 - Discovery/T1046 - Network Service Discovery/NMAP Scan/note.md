...
![test_machine_tcp_rfc_9293.PNG](./images/test_machine_tcp_rfc_9293.PNG)

It can be seen that there are extra flag type in TCP RFC 9293 (`CWR` and `ECE`) compared to TCP RFC 793.

### TCP RFC 9293

![tcp_rfc_9293_tcp_header.PNG](./images/tcp_rfc_9293_tcp_header.PNG)

### TCP RFC 793

![tcp_segment.JPG](./images/tcp_rfc_793_tcp_header.PNG)  
...
![ws_sT_scan_example.png](./images/ws_sT_scan_example.png)
...
![ws_sS_scan_example.png](./images/ws_sS_scan_example.png)
...
![ws_sF_scan_example.png](./images/ws_sF_scan_example.png)
...
![ws_sN_scan_example.png](./images/ws_sN_scan_example.png)
...
![ws_sX_scan_example.png](./images/ws_sX_scan_example.png)
...
![ws_sV_tcp_stream_1.PNG](./images/ws_sV_tcp_stream_1.PNG)

![ws_sV_tcp_stream_2.PNG](./images/ws_sV_tcp_stream_2.PNG)

![ws_sV_tcp_stream_3.PNG](./images/ws_sV_tcp_stream_3.PNG)
...
![ws_sV_UDP_prob_tcp_seq_gen.PNG](./images/ws_sV_UDP_prob_tcp_seq_gen.PNG)

### TCP explicit congestion notification (ECN)

![ws_sV_TCP_ecn.PNG](./images/ws_sV_TCP_ecn.PNG)

### TCP T2-T7

![ws_sV_TCP_prob_T2_T7.PNG](./images/ws_sV_TCP_prob_T2_T7.PNG)

### ICMP echo (IE)

![ws_sV_ICMP_probe_120.PNG](./images/ws_sV_ICMP_probe_120.PNG)

![ws_sV_ICMP_probe_150.PNG](./images/ws_sV_ICMP_probe_150.PNG)

### UDP (U1)

![ws_sV_UDP_probe.PNG](./images/ws_sV_UDP_probe.PNG)
